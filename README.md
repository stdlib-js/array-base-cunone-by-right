...
```javascript
cunoneByRight = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-cunone-by-right@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/array-base-cunone-by-right/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/array-base-cunone-by-right/actions/workflows/test.yml?query=branch:v0.1.1
